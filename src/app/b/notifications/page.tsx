  ...
  return (
    <div className="min-h-dvh bg-[color:var(--cream)] pb-24">
      ...
      <div className="px-5">
        ...
        <p className="mt-1.5 font-serif italic text-[14px] font-normal text-[color:var(--clay-deep)]">
          {unreadIds.length > 0
            ? `${unreadIds.length} new for you.`
            : "All caught up."}
        </p>
      </div>
      ...
      {!notifications || notifications.length === 0 ? (
        <div className="px-5 pt-8">
          <EmptyState
            ...
            tone="clay"
            title="Nothing new"
            description="Updates about applications and knots land here."
          />
        </div>
      ) : (
